...
public class ActivitySwitcher
{
	...
	private static void apply3DRotation(float fromDegree, float toDegree, boolean reverse, View container, WindowManager windowManager,
			final AnimationFinishedListener listener)
	{
		Point displaySize = new Point();
		windowManager.getDefaultDisplay().getSize(displaySize);
		final float centerX = displaySize.x / 2.0f;
		final float centerY = displaySize.y / 2.0f;
